...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,0.0.0.0,host.docker.internal,172.20.10.5,10.10.9.42,192.168.0.133,76.13.56.224,ease-dom.fr,www.ease-dom.fr,ease-dom.net,www.ease-dom.net,ease-dom.com,www.ease-dom.com', cast=lambda v: [s.strip() for s in v.split(',')])
...
REST_FRAMEWORK = {
    ...
    # Désactiver l'interface navigable en production (H3)
