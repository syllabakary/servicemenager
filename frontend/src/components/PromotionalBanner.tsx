...
export function PromotionalBanner() {
  ...
  return (
    <section className="banner-enhanced text-site-banner-text py-2 sm:py-3 overflow-x-hidden w-full max-w-full relative">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <Link href="/devis" className="w-full sm:w-auto">
              <Button size="sm" className="w-full sm:w-auto btn-primary">
                J'en profite !
              </Button>
            </Link>
          </motion.div>
